          ...
          <Fragment>
            ...
            <Container style={{ marginTop: '7em' }}>
              <Switch>
                ...
                <Route exact path='/exercise/solved/:exerciseId/group/:groupId/user/:studentId' component={SolvedExercise} />
                <Route exact path='/user/profile/:email' component={UserProfile} />
